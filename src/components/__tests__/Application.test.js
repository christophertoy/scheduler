...
describe("Application", () => {
  ...
  it("loads data, cancels an interview and increases the spot remaining for Monday by 1", async () => {
    ...
    // 4. Check that the confirmatio message is displayed.

    expect(
      getByText(appointment, "Are you sure you want to delete???")
    ).toBeInTheDocument();

    // 5. Click the the "Confirm" button
    ...
    // 7. Wait until the the "Add" button is displayed.
  ...
  it("loads data, edits an interview and keeps the spots remaining for Monday the same", async () => {
    ...
    // 4. Check that the appointment information is displayed.
    ...
    // 8. Wait until the new appointment information is displayed.

    await waitForElement(() => getByText(appointment, "Chris Toy"));
  ...
  it("shows the save error when failing to save an appointment", async () => {
    ...
    // 9. Expect that Error Message is displayed
  ...
  it("loads data, cancels an interview and increases the spot remaining for Monday by 1", async () => {
    ...
    // 8. Expect that the Error Message is displayed
